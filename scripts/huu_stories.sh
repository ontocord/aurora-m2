...
directory="/leonardo_work/EUHPC_E03_068/staging_data/huu-stories-wikiplot-test"
mkdir -p $directory
...
echo 'creating stories from wikiplots'
srun python -m src.create_multimodal_data \
     --task generate_stories \
     --input_dir /leonardo_work/EUHPC_E03_068/staging_data/ \
     --input_path /leonardo_work/EUHPC_E03_068/staging_data/wikiplots.jsonl \
     --output_dir $directory \
     --output_path $directory/stories.jsonl     
