...
output_directory="/leonardo_work/EUHPC_E03_068/datasets/safellm/data/stage1/fineweb_gov_deduped_en_de/"
...
srun python -m src.create_multimodal_data \
     ...
     --input_dir /leonardo_work/EUHPC_E03_068/datasets/safellm/data/stage1/fineweb_gov_deduped \
     --input_path /leonardo_work/EUHPC_E03_068/datasets/safellm/data/stage1/fineweb_gov_deduped/*/* \
     --output_dir $output_directory \
     --output_suffix _en_de
