...
def generate_image_and_outputs(prompt_array: list, suffix: str = "", batch_size: int = 4, score_cutoff: int = 0.2):
    ...
    print("detected_and_cleaned_texts:", detected_and_cleaned_texts)
    ...
    images = [replace_color_rectangles_with_text(image, detected_and_cleaned_text[2], detected_and_cleaned_text[0]) if detected_and_cleaned_text[2] else image for image, detected_and_cleaned_text in zip(images, detected_and_cleaned_texts) ]
