...
#     --batch_size 32
# # srun python -m src.purpleteam.create_image_multiprocessing \
# #     --cache_dir $cache_dir \
# #     --score_cutoff 0.14 \
# #     --input_dir data/test-commoncatalog-cc-by \
# #     --output_path $directory/commoncatalog_recaption.jsonl \
...
#      --output_path $directory/commoncatalog_image.jsonl \
#      --batch_size 8
# # srun python -m src.purpleteam.create_image_multiprocessing \
# #     --cache_dir $cache_dir \
# #     --input_path data/commoncatalog_recaption.jsonl \
# #     --output_path $directory/commoncatalog_image.jsonl \
# #     --batch_size 8 \
...
#      --cache_dir $cache_dir \
#      --score_cutoff 0.14 \
#      --input_path  $directory/commoncatalog_image.jsonl \
#      --output_dir $directory \
